        ...
        <Container className="mt-4">
            ...
            <Row className="justify-content-start"> 
                <Col xs={12} md={4} className="mb-3"> 
                    {/* Cadastro de Filmes */}
                    <Button variant="dark" as={Link} to="/filmes" className="w-100">
                        <i className="bi bi-film me-2"></i>Cadastro de Filmes
                    </Button>
                </Col>
                <Col xs={12} md={4} className="mb-3">
                    {/* Cadastro de Salas */}
                    <Button variant="dark" as={Link} to="/salas" className="w-100">
                        <i className="bi bi-door-open me-2"></i>Cadastro de Salas
                    </Button>
                </Col>
                <Col xs={12} md={4} className="mb-3">
                    {/* Cadastro de Sessões */}
                    <Button variant="dark" as={Link} to="/sessoes" className="w-100">
                        <i className="bi bi-calendar-check me-2"></i>Cadastro de Sessões
                    </Button>
                </Col>
                <Col xs={12} md={4} className="mb-3">
                    {/* Venda de Ingressos */}
                    <Button variant="dark" as={Link} to="/venda-ingressos" className="w-100">
